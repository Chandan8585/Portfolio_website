      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4 rounded-lg">
          <div className="flex items-center">
            <Link to={'/'}>
              <div className="flex-shrink-0 bg-red-500 rounded-full">
          ...
          <div className="flex items-center">
            <Link to={'https://github.com/chandan8585'} >
              <Button variant="ghost" size="icon" className="mr-2 bg-red-400">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className={`md:hidden ${activeSection === "aboutus" ? "text-gray-900" :
                  activeSection === "projects" ? "bg-red-500" :
              ...
              <SheetContent
                side="right"
                className="w-full sm:w-[300px] bg-red-300 backdrop-blur-lg"
              >
                <SheetHeader className="border-b border-red-900 pb-4">
