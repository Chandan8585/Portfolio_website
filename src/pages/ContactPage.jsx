...
export const ContactPage = () => {
  ...
  return (
    ...
    <SEO
        title="Contact"
        description="Welcome to my portfolio website. I'm a Full Stack Developer specializing in Devops and backend technologies."
        path="/contact"
      />
    <ReactLenis root>
      ...
      <section className={twMerge(
        ...
        <div className="">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link
              to="https://api.whatsapp.com/send?phone=7678668630"
              className={twMerge(
